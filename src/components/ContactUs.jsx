...
const ContactUs = () => {
  ...
  async function onSubmit(event) {
    ...
    formData.append("access_key", "be317ffa-4e41-44b2-bbb8-61654dd453a9");
    try {
  ...
  return (
    <div id="contact-us" className="flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white">
      ...
      <Title  title="Reach out to us"  desc="From stratagy to execution, we craft digital solutions that move your business forward."  />
     ...
     className="grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full"> 
       <div>
         ...
         <div className="flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600">
            <img src={assets.person_icon} alt="user_icon" />
       ...
       <div>
         ...
         <div className="flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600">
            <img src={assets.email_icon} alt="user_icon" />
       ...
       <button 
       className="w-max flex items-center justify-center gap-2 bg-primary text-white text-sm px-10 py-3 rounded-full cursor-pointer hover:scale-103 transition-all"
       type="submit">Submit <img src={assets.arrow_icon} alt="arrow_icon" className="w-4 "/> </button>
